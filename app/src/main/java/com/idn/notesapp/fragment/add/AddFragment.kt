...
class AddFragment : Fragment() {
    ...
    private fun insertDataToDatabase() {
        // membuat function masukan data ke db, nah pertama buat dulu var dari view yang dibutuhkan
        ...
        if (validation) {
            ...
            Toast.makeText(requireContext(), "Tolong Diisi Ya...", Toast.LENGTH_SHORT).show()
        }
    }
}